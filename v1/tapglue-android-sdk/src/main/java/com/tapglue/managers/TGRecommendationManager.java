...
public interface TGRecommendationManager {
    /**
     ...
     * @param callback
     */
    void getUsers(TGRecommendationType type, TGRecommendationPeriod period, @NonNull final TGRequestCallback<TGUsersList> callback);
}
